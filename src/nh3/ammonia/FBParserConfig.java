...
public class FBParserConfig {
  ...
  static public boolean initialize(final String[] args) {
    ...
    {
      final Option source =
          new Option("tr", "transitionresult", true, "transition result of bugs found by FindBugs");
    ...
    {
      final Option source =
          new Option("cp", "changepattern", true, "change patterns for removed bugs");
      source.setArgName("file");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("bt", "bugfixthreshold", true, "bugfix threshold of change pattterns");
    ...
    {
      final Option source =
          new Option("st", "supportthreshold", true, "support threshold of change pattterns");
      source.setArgName("value");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("ct", "confidencethreshold", true, "confidence threshold of change patterns");
      source.setArgName("file");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("db", "database", true, "change patterns found by CPAnalyzer");
      source.setArgName("file");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("svnrepo", "svnrepository", true, "svn repository of a target software");
    ...
    {
      final Option source =
          new Option("gitrepo", "gitrepository", true, "git repository of a target software");
      source.setArgName("number");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("startrev", "startrev", true, "revision number of the given XML file");
      source.setArgName("number");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("endrev", "endrev", true, "revision number of ending border");
      source.setArgName("number");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("fbresult", "fbresult", true, "a findbug's result on a target version");
    ...
    {
      final Option source =
          new Option("fbresults", "fbresults", true, "findbug's results on target versions");
    ...
    {
      final Option source =
          new Option("survivingbugscsv", "survivingbugscsv", true, "surviving bugs in CSV format");
    ...
    {
      final Option source =
          new Option("removedbugscsv", "removedbugscsv", true, "removed bugs in CSV format");
      source.setArgName("csvfile");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
    ...
    {
      final Option source =
          new Option("addedbugscsv", "addedbugscsv", true, "added bugs in CSV format");
      source.setArgName("csvfile");
      source.setArgs(1);
      source.setRequired(false);
      options.addOption(source);
  ...
  public List<String> getFBRESULTS() {
    ...
    final StringTokenizer tokenizer =
        new StringTokenizer(this.commandLine.getOptionValue("fbresults"), ";");
    while (tokenizer.hasMoreTokens()) {
