...
public class SourceLine implements Comparable<SourceLine> {
  ...
  public SourceLine(final String classname, final int start, final int end, final String sourcepath,
      final String name) {
  ...
  public int compareTo(final SourceLine target) {
    ...
    final int classnameComparison = this.classname.compareTo(target.classname);
  ...
  static public String makeText(final String element, final SourceLine sourceline) {
