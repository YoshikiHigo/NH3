...
public class LocationTransition {
  ...
  public boolean hasChanged() {
    ...
    if (latestRange instanceof Location_ADDITION || latestRange instanceof Location_DELETION
        || latestRange instanceof Location_REPLACEMENT || latestRange instanceof Location_UNKNOWN) {
      return true;
    } else {
      return false;
    }
