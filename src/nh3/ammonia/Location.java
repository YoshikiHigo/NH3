...
public class Location {
  ...
  public Location(final String path, final int startLine, final int endLine, final boolean bugfix) {
    this.path = path;
  ...
  public boolean equals(final Object o) {
    ...
    return this.path.equals(target.path) && (this.startLine == target.startLine)
